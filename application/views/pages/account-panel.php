...
<body>
						...
						<div ng-controller="AccordionCtrl">
  							<accordion close-others="oneAtATime">
    							<accordion-group>
        							...
        							<div class="row">
        								<div class="col-md-8">
        									<p>Aquí podras editar tus datos personales:</p>
		        							<form id="edit-account-form" name="EditAccountForm" ng-controller="EditAccountForm" action="<?= base_url() . 'account/update_account/' . $user_logged_account->id ?>" method="post" novalidate autocomplete="off">
			    								...
			    								<div class="row">
			    									<button type="submit" class="btn btn-primary center-horizontaly pull-right" ng-disabled="EditAccountForm.$invalid">Guardar</button>
			    								</div>
					    					</form>
				    					</div>
			    					</div>
					...
					<section id="my-purchases" class="col-md-12 no-padding" ng-if="myPurchasesSelected"> 
						...
						<div class="form-group">
						  ...
						  <button type="button" class="btn btn-info dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
						    direcciones <span class="caret"></span>
						  </button>
						  <ul class="dropdown-menu" role="menu">
						    <li><a href="#">Action</a></li>
						    <li><a href="#">Another action</a></li>
  ...
  <div class="panel-body">
    Panel content
					...
					<section id="my-diagnostic" class="col-md-8 no-padding" ng-if="myDiagnosticSelected">
						My diagnostic
					</section>
				</div>
			</div>
